// ==UserScript==
// @name         Random Post Button for MetroGreen Theme
...
function init_css(){
    ...
    <style>
        #random{position:absolute;top:76px;left:65%;height:25px;width:130px;}
        #random{background:#89C900;color:white;padding-top:0px;text-align:center;}
        #random{z-index:0;}
    </style>
    `;
}