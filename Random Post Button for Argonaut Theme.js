// ==UserScript==
// @name         Random Post Button for Argonaut Theme
...
function init_css(){
    ...
    <style>
        #random{position:absolute;top:70px;left:65%;height:70px;width:130px;}
        #random{background:#33b5e5;color:white;padding-top:0px;text-align:center;}
        #random{z-index:0;}
    </style>
    `;
}